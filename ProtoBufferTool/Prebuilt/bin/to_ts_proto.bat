...
protoc -I=proto_place_here proto_place_here/*.proto --js_out=import_style=commonjs:./generated_ts_protobuf --grpc-web_out=import_style=typescript,mode=grpcwebtext:./generated_ts_protobuf
